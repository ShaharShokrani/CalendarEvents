...
namespace CalendarEvents.Repository.Tests
{
    public class EventsServiceTests
    {
        ...
        [Test] public void Update_WhenCalled_ShouldCallDbSetContextUpdate()
        {
            ...
            //Act
            repository.Update(expectedItem);
        ...
        [Test] public void Update_NotFind_ShouldDoNothing()
        {
            ...
            //Assert
            context.Verify(x => x.SetEntityState<EventModel>(expectedItem, EntityState.Modified), Times.Never, "GetEntityState Failed");
            dbSetMock.Verify(x => x.Attach(It.Is<EventModel>(y => y == expectedItem)), Times.Never, "Remove Failed");
        }
        #endregion
